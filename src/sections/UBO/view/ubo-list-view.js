...
export default function UBOListView() {
  ...
  const handleViewRow = useCallback(
    (id) => {
      router.push(paths.dashboard.ubo.details(id));
    },
    [router]
  );
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        <Card>
          ...
          <UBOTableToolbar filters={filters} onFilters={handleFilters} />
