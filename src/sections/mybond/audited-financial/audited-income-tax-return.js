...
export default function AuditedIncomeTaxReturn({
  ...
  useEffect(() => {
    if (currentAuditedIncomeTaxReturn) {
      setAuditorName(currentAuditedIncomeTaxReturn.auditorName || '');
      setDocuments(currentAuditedIncomeTaxReturn.documents || documents);
    }
  }, [currentAuditedIncomeTaxReturn]);
